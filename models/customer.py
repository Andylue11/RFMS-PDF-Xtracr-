...
class Customer(db.Model):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'active_date': self.active_date.strftime('%Y-%m-%d') if self.active_date else None,
    ...
    def from_rfms_data(cls, rfms_data):
        ...
        customer = cls(
            ...
            active_date=datetime.strptime(rfms_data.get('activeDate', datetime.now().strftime('%Y-%m-%d')), '%Y-%m-%d'),
            default_store=rfms_data.get('storeCode')
        )
        
        if 'renewalDate' in rfms_data and rfms_data['renewalDate']:
            customer.renewal_date = datetime.strptime(rfms_data['renewalDate'], '%Y-%m-%d')
